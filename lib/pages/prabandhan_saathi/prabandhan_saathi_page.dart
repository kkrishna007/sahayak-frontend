...
import 'student_attendance_options_page.dart';

class PrabandhanSaathiPage extends StatefulWidget {
  const PrabandhanSaathiPage({super.key});

  @override
  State<PrabandhanSaathiPage> createState() => _PrabandhanSaathiPageState();
}

class _PrabandhanSaathiPageState extends State<PrabandhanSaathiPage>
        ...
        children: [
              ...
              const Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text(
                      'AI-powered school administration and analytics',
                      style: TextStyle(
                        color: Color(0xFF9C27B0),
                        fontSize: 14,
          ...
          _buildFeatureCard(
            ...
            () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const StudentAttendanceOptionsPage(),
              ),
            ),
          ),
          ...
          _buildFeatureCard(
            ...
            () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const StudentPerformancePage(),
              ),
            ),
          ),
          const SizedBox(height: 8),
          _buildFeatureCard(
            ...
            () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const TeachingSuggestionsPage(),
              ),
            ),
          ),
        ],
